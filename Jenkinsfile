pipeline {
    ...
    parameters {
        ...
        string(name: 'BUCKET_TARGET', defaultValue: 'bucket-codigo-pablo', description: 'Nombre del bucket objetivo..')
        string(name: 'CARPETA_USUARIO', defaultValue: 'pablo', description: 'Nombre de la carpeta del usuario..')
